...
- 🏗️ **SIP Content Reward Model**: A dedicated reward model (RMcontent) trained on **SocialPairs-20K**, a pairwise preference dataset of SIP-stage reasoning segments, for evaluating narrative-grounded mental-state attribution
